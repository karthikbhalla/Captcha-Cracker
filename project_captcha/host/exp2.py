...
for r in range(1,2):
	...
	for x in range(im.size[1]):
	  for y in range(im.size[0]):
		...
		temp[pix] = pix
#print pix
		if pix in range(0,70) : # these are the numbers to get
		  im2.putpixel((y,x),255)
		else:
			im2.putpixel((y,x),0)

	im2.save("C:\Users\Prasanth\Desktop\project_captcha\host\\crop"+str(xcount)+".gif")
	im2.save("C:\Users\Prasanth\Desktop\project_captcha\host\\crop"+str(xcount)+".gif")
	hm = im2.histogram();
	#print xcount
	for i in range(256):
	...
	if intens[0]==0:
		...
		imx.save("C:\Users\Prasanth\Desktop\project_captcha\host\\crop"+str(xcount)+".gif")

	for l in range(0,2):
		im3 = Image.open("C:\Users\Prasanth\Desktop\project_captcha\host\\crop"+str(xcount)+".gif")
		im3 = im3.convert("P")	
	...
	im3 = Image.open("C:\\Users\\Prasanth\\Desktop\\projectcaptcha\\host\\crop"+str(xcount)+".gif")
	im3 = im3.convert("P")	
	im4 = Image.new("P",im3.size,255)
	...
	for x in range(0,im3.size[0]):
		...
		if(countb<3 and flag2==1): #to find the end point of the crop part
			...
			#else:
			#	destinationDir='C:\\Users\\Prasanth\\Desktop\\comb\\Captcha-Cracker-master\\thecracked - Copy\\crops' # to save the crops into a folder
	...
	#im3.save("output"+str(xcount)+".gif")
execfile("C:\\Users\\Prasanth\\Desktop\\project_captcha\\host\\clean.py")
#execfile("C:\\Users\\Prasanth\\Desktop\\project_captcha\\host\\floodfill.py")
#os.chdir('C:\\Users\\Prasanth\\Desktop\\project_captcha\\host\\captcha2')
#execfile("C:\\Users\\Prasanth\\Desktop\\project_captcha\\host\\captcha2\\svmtrain.py")
