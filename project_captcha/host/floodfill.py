...
for abc in range(1,2):
	try:
		im2=Image.open("C:\\Users\\Prasanth\\Desktop\\project_captcha\\host\\output"+str(scount)+".gif")
	except:
		print 'cant open'
	scount=scount+1
		...
		for x in range(0,im2.size[1]):
			...
			if pix!=255 and pix!=10:
				...
				if checky==1:
					...
					working_slice.save("C:\\Users\\Prasanth\\Desktop\\project_captcha\\host\\letter"+str(xcount)+".gif",quality=95)
					destinationDir='C:\\Users\\Prasanth\\Desktop\\project_captcha\\host\\captcha2'
					shutil.move("C:\\Users\\Prasanth\\Desktop\\project_captcha\\host\\letter"+str(xcount)+".gif", destinationDir)
					pixcount=0
					highy=999
					lowy=0
				xcord=x
